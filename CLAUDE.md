...
> **定位**：這是擁有者的**個人**男裝潮流情報 + 挑買決策系統，**不是內容生產 / 拍片管線**。產出服務「我自己」（一個追潮流、會親手挑單品入手的玩家）。不要把產物導向短影音選題 / 社群貼文；daily brief 結尾是 `🛒 對我有用 For Me`，趨勢轉化走 `prompts/buy_picks.md`（挑買卡），不是 short video。
