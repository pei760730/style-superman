...
- 當月 daily briefs。
- 該地區量化基準：歐美 `data/rankings/lyst-index.yml`、`stockx.yml`；日本 `data/rankings/snkrdunk.yml`（SNKRDUNK（球鞋轉售，D24 2026-06-21 重建；按需 Firecrawl 抓 dated 快照）——⚠️ **服飾／精品仍空**（ZOZO 為 Akamai 級死界）），服飾／精品主榜仍依事件與媒體共識，信心保守。
