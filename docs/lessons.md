...
- **發生什麼**：排程 patrol 的死源清單三天三組、互不重疊、隔天全恢復：06-16=KR 三源（unreachable）、07-02=bof(403)/heddels/permanent-style(empty 200)、07-03=0 死源。外站瞬斷（暫時 403 / empty 200 / DNS 抖）被單次探測當成永久死源，寫進 issue #122、job 失敗又對 Kai 發紅通知。「死源」清單因此分不出真死 vs 瞬斷、失去可信度。
