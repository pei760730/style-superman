...
兩者剛好互補：Lyst 補精品/設計師視角，StockX 補街頭/球鞋實銷。男裝的全貌要兩個一起看。

## 檔案結構

```txt
data/rankings/
├── lyst-index.yml     # 季度快照，最新放最上
└── stockx.yml         # 年度/年中快照，最新放最上
...
### 看現在的榜
```bash
python scripts/track_rankings.py                 # Lyst + StockX 最新
...
下一期：Lyst Q2 2026、StockX 2026 年中報告發布時新增。
