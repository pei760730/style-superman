...
7. 固定填寫 `## 🛒 對我有用 For Me`（值得入手 / 想試的穿搭 / 想深入了解）：優先給實穿、可驗證、買得到的方向；訊號弱時只填有把握的項，不硬湊，也不能把待查訊號講成「現在最該買」。
...
- 結尾固定附「🛒 對我有用 For Me」：值得入手 / 想試的穿搭 / 想深入了解；想展開成完整挑買卡時連到 `prompts/buy_picks.md` 流程。
