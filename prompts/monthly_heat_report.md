...
8. **對照基準**：跟 repo 內該地區最新量化基準榜比——哪些一致、哪些是基準榜沒抓到的本月新訊號。直接讀骨架 🆚 段已嵌入的 Lyst 季變動，把「季榜在動 vs 本月媒體新訊號」分清楚。
   **基準新鮮度（#3，2026-06-14）**：只有 **Lyst（季）+ MUSINSA（30 天）算「現貨」基準**；**StockX / KREAM 是年度結算（一年一更）→ 當年度脈絡、不當每月即時訊號**；**Mercari 是 2013→2022 歷史區間 → 只當長期參考、不可拿來講「本月」**。引基準時標清楚是季/年度/歷史，別把年度或歷史數字寫成本月熱度。
